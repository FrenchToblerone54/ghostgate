...
- **لینک‌های اشتراک** - آدرس‌های اشتراک VLESS استاندارد با QR کد
...
این آدرس یک لیست کانفیگ VLESS رمزگذاری‌شده با base64 برمی‌گرداند که با کلاینت‌های VPN استاندارد سازگار است.
